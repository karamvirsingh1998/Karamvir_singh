...
IFontDisp = Font
__all__ = [ 'IFontEventsDisp', 'Monochrome', 'Gray', 'StdFont',
           'OLE_YSIZE_PIXELS', 'Unchecked', 'OLE_XPOS_PIXELS',
           'FONTUNDERSCORE', 'IPictureDisp', 'FONTBOLD',
           'OLE_YPOS_CONTAINER', 'OLE_XSIZE_PIXELS', 'IPicture',
           'OLE_HANDLE', 'OLE_YPOS_HIMETRIC', 'Color', 'IFontDisp',
           'OLE_XPOS_CONTAINER', 'OLE_CANCELBOOL',
           'LoadPictureConstants', 'FONTSIZE', 'Checked', 'OLE_COLOR',
           'FontEvents', 'OLE_YPOS_PIXELS', 'OLE_XSIZE_HIMETRIC',
           'OLE_XSIZE_CONTAINER', 'OLE_XPOS_HIMETRIC',
           'OLE_YSIZE_HIMETRIC', 'OLE_OPTEXCLUSIVE',
           'OLE_ENABLEDEFAULTBOOL', 'OLE_TRISTATE', 'IFont',
           'OLE_YSIZE_CONTAINER', 'FONTITALIC', 'Default', 'Font',
           'FONTNAME', 'StdPicture', 'FONTSTRIKETHROUGH', 'Picture',
           'VgaColor']
